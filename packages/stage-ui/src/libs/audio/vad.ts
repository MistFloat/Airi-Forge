...
export interface VADEvents {
  ...
  'speech-ready': { buffer: Float32Array, duration: number, voicedDurationMs: number, voicedRatio: number }
  // Emitted when a completed segment is intentionally filtered before encoding/upload
  'speech-rejected': { duration: number, reason: 'too-short' | 'too-sparse', voicedDurationMs: number, voicedRatio: number }
